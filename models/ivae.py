...
class IVAE(nn.Module):
    def __init__(self, latent_dim, data_dim, aux_dim, hidden_dim=50, prior=None, decoder=None, encoder=None,
                 n_layers=3, activation='lrelu', slope=.1, device='cpu', anneal=False):
        super().__init__()
